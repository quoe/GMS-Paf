//SURFACE_CREATE_BORDERS_Create_script1
//!!!NOT USED!!!
//Smeschenie s kraju
...
if argument2 == 0 
    hide_stec_object = spr_Border_Green_Flower
else
    hide_stec_object = argument2;
    
//Bonusnie elementi
if argument3 == 0 
    decorate_object = spr_Border_Green_List
else
...
for (var i = 0; i < count + 2; i++)
{
    ...
    if !surface_exists(surf)
    {
        ...
        draw_sprite_ext(hide_stec_object, -1, new_x - 10, top_delta - 2, random_range(min_random_xscale, 1), 
            image_xscale, random(360), image_blend, image_alpha); 
